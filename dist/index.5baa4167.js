...
new (0, _deckJsDefault.default)(options).createFullDeck().shuffle().displayCards();
    ...
    createFullDeck() {
        this.values.forEach((v)=>{
            this.suits.forEach((s)=>{
                this.#cards.push(new (0, _cardJsDefault.default)(v, s));
            });
        });
        return this;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hbj89","igcvL"], "igcvL", "parcelRequire3c44")
